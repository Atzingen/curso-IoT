...
def cria_tabela_sensores():
    try:
        ...
        temperatura REAL, potenciometro REAL, nome TEXT,
...
def adiciona_dado_sensores(temperatura, umidade, nome):
	try:
		...
		cursor.execute('''INSERT INTO sensores (tempo, temperatura, potenciometro, nome)
							VALUES(?,?,?,?)''',(tempo, temperatura, potenciometro, nome))
		conect.commit()
		conect.close()
